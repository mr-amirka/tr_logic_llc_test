...
5. Загрузка нескольких изображений в текстовом формате с BASE64 закодированным содержимым или со сторонних ресурсов по заданному URL, разделенных переводом строки.  
